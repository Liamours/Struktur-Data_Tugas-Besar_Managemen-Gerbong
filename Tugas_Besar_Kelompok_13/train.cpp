...
void initListGerbong(listGerbong &G) {
    // I.S. listGerbong G yang belum di inisiasi
    // F.S. firstGerbong dan lastGerbong dari listGerbong G di assign dengan NULL
...
void insertGerbongDepan(listGerbong &G, adrGerbong &pG) {
    ...
    if (searchGerbong(G, idGerbong(pG)) != NULL) {
        ...
        return;  // Menghindari penambahan gerbong yang sudah ada
    }
...
void showAllGerbong(listGerbong G) {
    ...
    // F.S. menampilkan seluruh gerbong dan data nya pada setiap gerbong di list gerbong
...
void handle_menuStart() {
    // I.S. -
    // F.S. Mengatur cara kerja menu start
    char choice;
    bool exitMenu = false;
...
void importTemplateTrain() {
    ...
    struct GerbongData { int id; string nama, kelas; int harga; } gerbongData[] = {
        {1, "Gerbong A", "Eksekutif", 500000}, {2, "Gerbong B", "Bisnis", 350000},
        {3, "Gerbong C", "Ekonomi", 200000}, {4, "Gerbong D", "Ekonomi", 150000},
        {5, "Gerbong E", "Eksekutif", 550000}, {6, "Gerbong F", "Ekonomi", 120000},
        {7, "Gerbong G", "Eksekutif", 600000}, {8, "Gerbong H", "Bisnis", 400000},
        {9, "Gerbong I", "Ekonomi", 180000}, {10, "Gerbong J", "Eksekutif", 650000}
    };
    ...
    struct PenumpangData { int id; string nama; int kursi; } penumpangData[] = {
        {1, "John Doe", 1}, {2, "Jane Smith", 2}, {3, "Alice Brown", 3}, {4, "Bob Johnson", 4},
        {5, "Charlie Davis", 5}, {6, "David Wilson", 6}, {7, "Eve Thomas", 7}, {8, "Frank Miller", 8},
        {9, "Grace Lee", 9}, {10, "Henry King", 10}, {11, "Ivy Evans", 1}, {12, "Jack Lewis", 2},
        {13, "Lily Adams", 3}, {14, "Mason Harris", 4}, {15, "Nina Scott", 5}, {16, "Oliver Young", 6},
        {17, "Paula Green", 7}, {18, "Quinn Carter", 8}, {19, "Ryan Hill", 9}, {20, "Sophia Moore", 10},
        {21, "Tom Hall", 1}, {22, "Uma Taylor", 2}, {23, "Vera Allen", 3}, {24, "William Nelson", 4},
        {25, "Xena Baker", 5}
    };
    ...
    for (int i = 0; i < 10; ++i) {
        int penumpangPerGerbong = 10; // Setiap gerbong memiliki 10 penumpang

        for (int j = 0; j < penumpangPerGerbong; ++j) {
            if (penumpangIndex >= 25) break;  // Jika semua penumpang sudah dimasukkan, keluar dari loop
        ...
        if (penumpangIndex >= 25) break;  // Jika semua penumpang sudah dimasukkan, keluar dari loop
        if (i < 9) tempG = nextGerbong(tempG);  // Pindah ke gerbong berikutnya
    }
}

void handle_menuMain() {
    // I.S. -
    // F.S. mengatur cara kerja menu main
    char choice;
    bool exitMenu = false;
...
void handle_menuInsert() {
    // I.S. -
    // F.S. mengatur cara kerja menu insert
    char choice;
    bool exitMenu = false;
...
void handle_menuDelete() {
    // I.S. -
    // F.S. mengatur cara kerja menu delete
    char choice;
    bool exitMenu = false;
...
void handle_menuSearch() {
    // I.S. -
    // F.S. mengatur cara kerja menu search
    char choice;
    bool exitMenu = false;
...
void handle_menuExit() {
    // I.S. -
    // F.S. mengatur cara kerja menu exit
    char choice;
